@{
    ...
    FunctionsToExport = 'New-OptimizelyCmsResourceGroup', 'Get-OptimizelyCmsConnectionStrings', 'New-EpiserverCmsResourceGroup', 'Get-EpiserverCmsConnectionStrings', 'Add-AzureDatabaseUser', 'Backup-Database', 'Copy-Database', "Remove-Blobs", "Copy-Blobs"
    CmdletsToExport   = @()
    AliasesToExport   = @()
}