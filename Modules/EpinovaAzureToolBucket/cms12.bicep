...
module web 'Modules/web.bicep' = {
  ...
  params: {
    ...
    databaseConnectionStrings: {
      'EPiServerDB': 'Server=tcp:${sql.outputs.fullyQualifiedDomainName},1433;Initial Catalog=sqldb-${uniqueName}-${episerverDbName}-${environmentName};User Id=${sqlserverAdminLogin};Password=${sqlserverAdminLoginPassword};Trusted_Connection=False;Encrypt=True;Connection Timeout=30;MultipleActiveResultSets=True'
    }
